"""CI/CD configuration generator for prompt-git-manager.
...
---
<sub>Generated by <a href="https://github.com/ChanChiChoi/prompt-git-manager">prompt-git-manager</a> CI Guard</sub>`;
...
def generate_version_bump_script() -> str:
    ...
    """
    return """#!/bin/bash
# Version bump script for prompt-git-manager
